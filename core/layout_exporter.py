# -*- coding: utf-8 -*-
"""
PKL Pipeline - Layout Exporter
Exporta grupos a FBX para layout (cambia animation por layout en paths)
"""
...
def export_group_to_fbx(group_data, start_frame, end_frame):
    ...
    # 2. Resolver path (con cambio animation->layout)
    export_dir = resolve_export_path(path_template)
    
    print("  Layout Path: {}".format(export_dir))
...
def export_layout():
    """
    FUNCION PRINCIPAL - Exporta toda la escena para LAYOUT
    
    Busca todos los grupos exportables, valida skeletons y exporta FBX
    a la carpeta layout en vez de animation
    """
    print("\n" + "=" * 60)
    print("PKL PIPELINE - LAYOUT EXPORTER")
    print("=" * 60)
    ...
    print("\n" + "=" * 60)
    print("STARTING LAYOUT EXPORT PROCESS")
    print("=" * 60)
    ...
    # 4. Mostrar resumen
    print("\n" + "=" * 60)
    print("LAYOUT EXPORT COMPLETE - SUMMARY")
    print("=" * 60)
